...
# read shapefile
districts = gpd.read_file("/app/districts2/CBF_RO1872_CSRS.shp")
...
votes = pd.read_csv("voting_data/Canada1872.txt", sep=" ", header=0)
...
with open('voting_data/Canada1872.txt') as file:
...
sorted_parliament_seats = parliament_charts.create_parliament_seating_plan_1872(CON_SEATS, LIB_SEATS, INDEPENDENT_SEATS)

parliament_chart = parliament_charts.generateParliamentChart(total_seats, sorted_parliament_seats)

with open("pages/main/parliament_charts/parl_chart1872.html", "w") as file:
...
foliumMap.save("./pages/elections/election1872.html")

### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1872)
