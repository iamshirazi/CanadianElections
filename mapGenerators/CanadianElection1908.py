...
# read shapefile
districts = gpd.read_file("/app/CBF_RO1905_CSRS.shp")
...
correct_wentworth = gpd.read_file("/app/CBF_RO1903_CSRS.shp")
...
correct_districts= gpd.read_file("/app/CBF_RO1903_CSRS.shp")
...
generateHtmlMapFiles.generateElectionMapFile(1908)
