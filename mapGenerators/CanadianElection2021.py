...
# read shapefile
districts = gpd.read_file("/app/districts2/lfed000b16a_e.shp")
...
with open("pages/main/parliament_charts/parl_chart2021.html", "w") as file:
...
generateHtmlMapFiles.generateElectionMapFile(2021)
