...
votes = pd.read_csv("voting_data/Canada1874.txt", sep=" ", header=0)
...
with open('voting_data/Canada1874.txt') as file:
...
foliumMap.save("./pages/elections/election1874.html")

### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1874)
