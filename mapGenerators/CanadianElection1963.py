...
votes = pd.read_csv("voting_data/Canada1963.txt", sep=" ", header=0)
...
with open('voting_data/Canada1963.txt') as file:
...
sorted_parliament_seats = parliament_charts.create_parliament_seating_plan_1963(PROGRESSIVE_CONSERVATIVE_SEATS, LIBERAL_SEATS, SOCIAL_CREDIT_SEATS, NEW_DEMOCRATIC_SEATS, LIBERAL_LABOUR_SEATS)

parliament_chart = parliament_charts.generateParliamentChart(total_seats, sorted_parliament_seats)

with open("pages/main/parliament_charts/parl_chart1963.html", "w") as file:
...
foliumMap.save("./pages/elections/election1963.html")


### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1963)
