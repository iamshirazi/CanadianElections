...
votes = pd.read_csv("voting_data/Canada1965.txt", sep=" ", header=0)
...
with open('voting_data/Canada1965.txt') as file:
...
sorted_parliament_seats = parliament_charts.create_parliament_seating_plan_1965(PROGRESSIVE_CONSERVATIVE_SEATS, LIBERAL_SEATS, SOCIAL_CREDIT_SEATS, NEW_DEMOCRATIC_SEATS, RALLIEMENT_SEATS, INDEPENDENT_SEATS)

parliament_chart = parliament_charts.generateParliamentChart(total_seats, sorted_parliament_seats)

with open("pages/main/parliament_charts/parl_chart1965.html", "w") as file:
...
foliumMap = dataframe3.explore(
    ...
    cmap=['#847e7e', '#EE3224', '#F58220', '#0F2D52', '#005F00', '#005F00'],
    style_kwds=dict(color="black"), #use black outline
)

foliumMap.save("./pages/elections/election1965.html")


### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1965)
