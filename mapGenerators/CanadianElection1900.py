...
# read shapefile
districts = gpd.read_file("/app/districts2/CBF_RO1892_CSRS.shp")
...
votes = pd.read_csv("voting_data/Canada1900.txt", sep=" ", header=0)
...
with open('voting_data/Canada1900.txt') as file:
...
with open("pages/main/parliament_charts/parl_chart1900.html", "w") as file:
...
foliumMap.save("./pages/elections/election1900.html")

### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1900)
