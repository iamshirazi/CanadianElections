...
votes = pd.read_csv("voting_data/Canada1887.txt", sep=" ", header=0)
...
with open('voting_data/Canada1887.txt') as file:
...
with open("pages/main/parliament_charts/parl_chart1887.html", "w") as file:
...
foliumMap.save("./pages/elections/election1887.html")

### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1887)
