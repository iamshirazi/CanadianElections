...
votes = pd.read_csv("voting_data/Canada1957.txt", sep=" ", header=0)
...
with open('voting_data/Canada1957.txt') as file:
...
sorted_parliament_seats = parliament_charts.create_parliament_seating_plan_1957(PROGRESSIVE_CONSERVATIVE_SEATS, LIBERAL_SEATS, CC_FEDERATION_SEATS, SOCIAL_CREDIT_SEATS, INDEPENDENT_SEATS, LIBERAL_LABOUR_SEATS)

parliament_chart = parliament_charts.generateParliamentChart(total_seats, sorted_parliament_seats)

with open("pages/main/parliament_charts/parl_chart1957.html", "w") as file:
...
foliumMap = dataframe3.explore(
    ...
    cmap=['#FF9900', '#847e7e', '#EE3224', '#A91CB9', '#0F2D52', '#005F00'],
    style_kwds=dict(color="black"), #use black outline
)

foliumMap.save("./pages/elections/election1957.html")

### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1957)
