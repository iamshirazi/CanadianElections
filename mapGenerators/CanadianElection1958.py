...
votes = pd.read_csv("voting_data/Canada1958.txt", sep=" ", header=0)
...
with open('voting_data/Canada1958.txt') as file:
...
sorted_parliament_seats = parliament_charts.create_parliament_seating_plan_1958(PROGRESSIVE_CONSERVATIVE_SEATS, LIBERAL_SEATS, CC_FEDERATION_SEATS, LIBERAL_LABOUR_SEATS)

parliament_chart = parliament_charts.generateParliamentChart(total_seats, sorted_parliament_seats)

with open("pages/main/parliament_charts/parl_chart1958.html", "w") as file:
...
foliumMap = dataframe3.explore(
    ...
    cmap=['#FF9900', '#EE3224', '#A91CB9', '#0F2D52'],
