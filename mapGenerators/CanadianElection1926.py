...
# read shapefile
districts = gpd.read_file("/app/districts2/CBF_RO1924_CSRS.shp")
...
votes = pd.read_csv("voting_data/Canada1926.txt", sep=" ", header=0)
...
with open('voting_data/Canada1926.txt') as file:
...
sorted_parliament_seats = parliament_charts.create_parliament_seating_plan_1926(CONSERVATIVE_SEATS, LIBERAL_SEATS, PROGRESSIVE_SEATS, UF_ALBERTA_SEATS, LIBERAL_PROGRESSIVE_SEATS, LABOUR_SEATS, INDEPENDENT_SEATS, UF_ONTARIO_SEATS)

parliament_chart = parliament_charts.generateParliamentChart(total_seats, sorted_parliament_seats)

with open("pages/main/parliament_charts/parl_chart1926.html", "w") as file:
...
foliumMap = dataframe3.explore(
    ...
    cmap=['#0F2D52', '#847e7e', '#FF8ADC', '#EE3224', '#00DCB0', '#0DBA13', '#C0BD07', '#C0BD07'],
    style_kwds=dict(color="black"), #use black outline
)

foliumMap.save("./pages/elections/election1926.html")

### Generate election page in main folder
generateHtmlMapFiles.generateElectionMapFile(1926)
