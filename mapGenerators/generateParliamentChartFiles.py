...
def generateParliamentChart(total_seats, sorted_parliament_seats):
    ...
    if number_of_seats_per_row == 21 \
        or number_of_seats_per_row == 23 \
        or number_of_seats_per_row == 24 \
...
def create_parliament_seating_plan_1974(prog_con_seats, lib_seats, new_democratic_seats, social_credit_seats, independent_seats):
    parliament_seats = []
