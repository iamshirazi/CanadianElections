...
np.savetxt(r'./voting_data/ElectionData1949.txt', dataframe2.values, fmt='%s')
...
def set_other_votes(election_data, index):
    ...
    elif loser_party == "Union-of-Electors" and int(party_votes[7]) == 0:
    ...
    elif loser_party == "Labor-Progressive-Party" and int(party_votes[8]) == 0:
...
### Read ElectionData1949.txt, everytime a line starts with a name, append it to the previous line.
with open("./voting_data/ElectionData1949.txt", "r") as file:
...
with open("./voting_data/Canada1949.txt", "w") as file:
