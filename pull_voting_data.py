...
np.savetxt(r'./voting_data/ElectionData1968.txt', dataframe2.values, fmt='%s')
...
def set_accilmation_votes(election_data):
    ...
    elif winner_party == "Ralliement-des-créditistes":
...
def set_other_votes(election_data, index):
    ...
    elif loser_party ==  "Ralliement-des-créditistes" and int(party_votes[3]) == 0:
    ...
    elif loser_party == "Social-Credit-Party-of-Canada" and int(party_votes[4]) == 0:
    ...
    elif (loser_party == "Liberal-Labour-Party") and int(party_votes[6]) == 0:
    ...
    elif loser_party == "Communist-Party-of-Canada" and int(party_votes[7]) == 0:
...
### Read ElectionData1968.txt, add voting data for a riding into 
# an array and check who the winner is, append formatted voting data to modified_lines, loop through all ridings
with open("./voting_data/ElectionData1968.txt", "r") as file:
...
with open("./voting_data/Canada1968.txt", "w") as file:
