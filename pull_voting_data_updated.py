...
np.savetxt(r'./voting_data/ElectionData1896.txt', dataframe2.values, fmt='%s')
...
with open("./voting_data/ElectionData1896.txt", "r") as file:
...
with open("./voting_data/Canada1896.txt", "w") as file:
